...
//             <span className="text-xl tracking-tight">KKR</span>
//           </div>
...
// Updated navItems with href values pointing to section IDs
const navItems = [
  ...
  return (
    <nav className="sticky top-0 z-50 py-3 backdrop-blur-lg border-b border-neutral-700/80">
      <div className="container px-4 mx-auto relative lg:text-sm">
        <div className="flex justify-between items-center">
          <div className="flex items-center flex-shrink-0">
            <img className="h-10 w-18 ml-2 mr-2" src={logo} alt="Logo" />
            {/* <span className="text-xl tracking-tight">Harsh</span> */}
          </div>
          ...
          <ul className="hidden lg:flex ml-14 space-x-12">
            {navItems.map((item, index) => (
              <li key={index}>
                ...
                <a href={item.href} className="hover:text-green-500 transition-colors duration-300">
                  {item.label}
                </a>
              </li>
            ))}
